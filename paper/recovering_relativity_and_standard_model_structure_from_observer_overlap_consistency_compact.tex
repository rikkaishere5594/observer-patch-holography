...
Steps 2--4 are carried out inside the connected positive-dimensional Lie admissible class fixed by the weak-type / color-type criteria above. The existence of one connected abelian factor is supplied by the admissibility/MAR package; the proof below derives the minimal coupled carrier, the commuting product structure, and the uniqueness of that abelian factor on the minimal carrier.
