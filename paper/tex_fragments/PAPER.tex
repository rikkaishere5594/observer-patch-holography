...
\textbf{D8} & Section 6.2: product gauge structure up to finite quotient & D7 + Axiom 5 (MAR) & compact Lie representation classification; Schur's lemma & connected admissible class, one connected abelian factor, faithful action on the minimal coupled carrier, and \([z]=0\) & realized-branch theorem \\
...
These are realized-branch conclusions inside the connected admissible class. The proof still uses the one-connected-abelian-factor premise, the connected-Lie representation-classification input, and the faithful action on the minimal coupled carrier; it is not MAR in isolation.
...
\textbf{D8} & product gauge structure up to finite quotient under MAR & compact Lie representation classification; Schur's lemma & MAR, connected admissible class, one connected abelian factor, faithful action on the minimal coupled carrier, and \([z]=0\) & Phase I realized-branch theorem \\
